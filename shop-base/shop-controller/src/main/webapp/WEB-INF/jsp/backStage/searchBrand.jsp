				...
				<div class="panel-body">
						<form id="loginform" action="${pageContext.request.contextPath}/backstage/searchBrandsByBname?pn=1" method="post" >
							<div class="form-group">
								...
								<li><input type="text" name="bname" class="form-control" placeholder="品牌名" value="${bname}"></li>
			...
			<c:forEach items="${pageInfo.list }" var="brands">
				<tr class="hehe">
					...
					<td>
						...
						<ul class="pagination">
							<li><a href="${pageContext.request.contextPath}/backstage/searchBrandsByBname?bname=${bname}&pn=1">首页</a></li>
							<c:if test="${pageInfo.hasPreviousPage}">
								<li><a href="${pageContext.request.contextPath}/backstage/searchBrandsByBname?bname=${bname}&pn=${pageInfo.pageNum - 1 }" aria-label="Previous"> <span
							...
							<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
								...
								<c:if test="${page_Num != pageInfo.pageNum }">
									<li><a href="${pageContext.request.contextPath}/backstage/searchBrandsByBname?bname=${bname}&pn=${page_Num }">${page_Num}</a></li>
								</c:if>
							</c:forEach>
							<c:if test="${pageInfo.hasNextPage}">
								<li><a href="${pageContext.request.contextPath}/backstage/searchBrandsByBname?bname=${bname}&pn=${pageInfo.pageNum + 1 }" aria-label="Next"> <span
										aria-hidden="true">&raquo;</span>
									</a>
								</li>
							</c:if>
							<li><a href="${pageContext.request.contextPath}/backstage/searchBrandsByBname?bname=${bname}&pn=${pageInfo.pages }">末页</a></li>
						</ul>
				</div>
			</div>
