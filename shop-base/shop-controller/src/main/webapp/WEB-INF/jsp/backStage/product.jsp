		    	...
		    	<div class="panel-body">
		    		...
		    		<form action="${pageContext.request.contextPath}/backstage/searchproductbackstage" method="post">
		    				<div class="form-group">
		    					...
		    					<li><input type="text" name="productName" class="form-control" placeholder="商品名"></li>
			...
			<tr class="hehe">
				...
				<td>
					...
					<c:if test="${product.pflag =='0'}">
						...
						<ul class="pagination">
							<li><a href="${pageContext.request.contextPath}/backstage/productBackStage?pn=1">首页</a></li>
							<c:if test="${pageInfo.hasPreviousPage}">
								<li><a href="${pageContext.request.contextPath}/backstage/productBackStage?pn=${pageInfo.pageNum - 1 }" aria-label="Previous"> <span
							...
							<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
								...
								<c:if test="${page_Num != pageInfo.pageNum }">
									<li><a href="${pageContext.request.contextPath}/backstage/productBackStage?pn=${page_Num }">${page_Num}</a></li>
								</c:if>
							</c:forEach>
							<c:if test="${pageInfo.hasNextPage}">
								<li><a href="${pageContext.request.contextPath}/backstage/productBackStage?pn=${pageInfo.pageNum + 1 }" aria-label="Next"> <span
										aria-hidden="true">&raquo;</span>
									</a>
								</li>
							</c:if>
							<li><a href="${pageContext.request.contextPath}/backstage/productBackStage?pn=${pageInfo.pages }">末页</a></li>
						</ul>
